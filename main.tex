...
\cftsetindents{chapter}{0.05in}{0.5in}
\cftsetindents{section}{0.1in}{0.3in}

\definecolor{yourcolor}{HTML}{bbbbbb}
...
\titleformat{\chapter}[display]
  ...
  {\filleft\Huge\sffamily\bfseries\hspace*{2mm}
    \begin{tikzpicture}[baseline={([yshift=-.6ex]current bounding box.center)}]
      \node[fill=yourcolor,circle,text=black] {\thechapter};
    \end{tikzpicture}}
  {1ex}
...
\newcommand{\printmyminitoc}{%
    ...
    \begin{tikzpicture}
      ...
      %\node[rounded corners,align=left, blur shadow={shadow blur steps=5}, inner sep=5mm]{%
        \color{black}%
