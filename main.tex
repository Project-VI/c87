\documentclass[9pt,b5paper]{jsbook}
...
\begin{itemize}
  \item http://docs.openstack.org/juno/install-guide/install/yum/content/
  \item http://docs.openstack.org/juno/install-guide/install/apt/content/
\end{itemize}
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=10cm]{./img/boot.pdf}
  \end{center}
\end{figure}
