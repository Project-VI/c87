...
できましたか？はい、できませんね。僕もできませんでした\marginpar{\scriptsize これは未だに情況が改善していない。やはりdevstackの使い方は難しいし、何せgit logを見ないと仕様変更についていけない。コンピューターサイエンスは技術のコモディティ化を目指す、少し珍しい技術領域だと思う。1人が100人を動かし、その100人が1000人の職を奪う技術である。}。何を起動するの？ってか何をしたらOpenStackをセットアップしたことになるの？というかそもそも、何をインストールするの？疑問はどんどん不信に変わっていきます。
...
\url{https://github.com/Project-VI/c87/blob/master/orig/4-1-userdata_py.txt}
...
\begin{minipage}{\textwidth}
	...
	keystone先生が飼ってるワインレッドの猫。先生の胸の谷間におさまるのがお気に入り。
	...
	「ねえねえ見て見て！どれにする？？」とカタログを開いて迫ってくるけど選んだら選んだで
